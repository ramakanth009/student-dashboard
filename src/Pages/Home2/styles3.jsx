...
export const useStyles = makeStyles(() => ({
  ...
  // Welcome Banner Styles - Orange theme
  welcomeBanner: {
    width: "100%",
    marginBottom: "24px"
  },
  bannerPaper: {
    background: "linear-gradient(135deg, #FF7E1D 0%, #FF4800 100%) !important",
  ...
  dayBox: {
    ...
    "&:hover": {
      ...
      boxShadow: "0 4px 12px rgba(255, 72, 0, 0.15) !important",
    },
  },
  emptyDayBox: {
    width: "100px",
  ...
  activeDay: {
    borderColor: "#FF4800",
    borderWidth: "2px",
    backgroundColor: "rgba(255, 72, 0, 0.05) !important"
  },
  dayName: {
  ...
  visitButton: {
    ...
    fontSize: "0.875rem !important",
    "&:hover": {
      backgroundColor: "rgba(255, 72, 0, 0.08) !important",
    },
  },
  coursesGrid: {
    display: "grid",
  ...
  sectionDivider: {
    ...
    backgroundColor: "rgba(255, 72, 0, 0.1) !important",
  },
  // Progress Bar Styles
  progressContainer: {
    width: "100%",
