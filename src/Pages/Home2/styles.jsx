...
// Create styles without dynamic theme parameter
export const useStyles = makeStyles(() => ({
  ...
  // Welcome Banner Styles - Yellow to Orange theme by default
  welcomeBanner: {
    width: "100%",
    marginBottom: "24px"
  },
  bannerPaper: {
    background: "linear-gradient(135deg, #FFB800 0%, #F47B20 100%) !important",
  ...
  dayBox: {
    ...
    "&:hover": {
      ...
      boxShadow: "0 4px 12px rgba(244, 123, 32, 0.15) !important",
    },
  },
  emptyDayBox: {
    width: "100px",
  ...
  activeDay: {
    borderColor: "#F47B20",
    borderWidth: "2px",
    backgroundColor: "rgba(244, 123, 32, 0.05) !important"
  },
  dayName: {
  ...
  visitButton: {
    ...
    fontSize: "0.875rem !important",
    "&:hover": {
      backgroundColor: "rgba(244, 123, 32, 0.04) !important",
    },
  },
  coursesGrid: {
    display: "grid",
  ...
  sectionDivider: {
    ...
    backgroundColor: "rgba(244, 123, 32, 0.1) !important",
  },
  // Progress Bar Styles
  progressContainer: {
    width: "100%",
