...
export const useStyles = makeStyles(() => ({
  ...
  // Welcome Banner Styles - Orange to Yellow theme
  welcomeBanner: {
    width: "100%",
    marginBottom: "24px"
  },
  bannerPaper: {
    background: "linear-gradient(135deg, #F47B20 0%, #FFB800 100%) !important",
  ...
  visitButton: {
    ...
    fontSize: "0.875rem !important",
    "&:hover": {
      backgroundColor: "rgba(244, 123, 32, 0.08) !important",
    },
  },
  coursesGrid: {
    display: "grid",
